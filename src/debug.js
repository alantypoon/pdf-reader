 ...
 *
 *   DEBUG_ANNO_STROKES          = 993   pointer events: down/move/up tracing for stroke drawing
...
export const DEBUG_ANNO_STROKES = 993;
export const DEBUG_LOADING_PAGE_IMAGES = 994;
export const DEBUG_MYSCROLL = 995;
export const DEBUG_MYLOCALSTORAGE = 996
export const DEBUG_SCROLLING_MOMENTUM = 999;
